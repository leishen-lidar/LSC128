...
#include <lslidar_c128_driver/lslidar_c128_driver.h>

namespace lslidar_c128_driver {

LslidarC128Driver::LslidarC128Driver(
...
bool LslidarC128Driver::loadParameters() {
...
bool LslidarC128Driver::createRosIO() {

  // ROS diagnostics
  diagnostics.setHardwareID("Lslidar_C128");
  // c128 publishs 20*16 thousands points per second.
  ...
  ROS_INFO("expected frequency: %.3f (Hz)", diag_freq);
    ...
    // Output
    packet_pub = nh.advertise<lslidar_c128_msgs::LslidarC128Packet>(
                "lslidar_packet", 100);
    return true;
}

bool LslidarC128Driver::openUDPPort() {
...
bool LslidarC128Driver::initialize() {
    ...
    ROS_INFO("Initialised lslidar c128 without error");
    return true;
}

int LslidarC128Driver::getPacket(
        lslidar_c128_msgs::LslidarC128PacketPtr& packet) {
...
bool LslidarC128Driver::polling()
{
    // Allocate a new shared pointer for zero-copy sharing with other nodelets.
    lslidar_c128_msgs::LslidarC128PacketPtr packet(
                new lslidar_c128_msgs::LslidarC128Packet());
...
void LslidarC128Driver::initTimeStamp(void)
{
    int i;
...
void LslidarC128Driver::getFPGA_GPSTimeStamp(lslidar_c128_msgs::LslidarC128PacketPtr &packet)
{
